...
# Save plot
ggsave(file = here("output/fig/final/pdf/figA1.pdf"),
       plot = dend + theme(legend.position = "none"),
       width = 6, height = 5,
       bg = "white")
ggsave(file = here("output/fig/final/eps/figA1.eps"),
       plot = dend + theme(legend.position = "none"),
       width = 6, height = 5,
       device = cairo_ps)

emf(here("output/fig/final/emf/figA1.emf"), width = 6, height = 5)
